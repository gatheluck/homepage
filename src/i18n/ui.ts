...
export const ui = {
  en: {
    // Site Metadata
    'siteMetadata.title': 'Yoshihiro Fukuhara',
    'siteMetadata.headerTitle': 'Yoshihiro Fukuhara',
    'siteMetadata.description':
      'Personal website of Yoshihiro Fukuhara - Research Engineer specializing in Computer Vision and Machine Learning',
