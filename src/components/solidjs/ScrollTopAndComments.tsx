  ...
  onMount(() => {
    const handleScroll = () => {
      ...
      if (showComments && scrollCommentsRef) {
        const nearBottom = docHeight <= BOTTOM_THRESHOLD || scrollY >= docHeight - BOTTOM_THRESHOLD
    ...
    <>
      ...
      <div class="fixed bottom-8 right-8 hidden flex-col gap-3 md:hidden z-10" ref={scrollTopRef}>
        <button
          ...
          class="bg-surface ring-hairline text-fg-muted hover:text-fg rounded-full p-2 ring-1 transition-colors"
        >
